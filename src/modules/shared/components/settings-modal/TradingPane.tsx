...
/**
 * Dumb Trading section: the global Pro / Simple Trading Mode toggle, relocated
 * here from the old single Appearance pane (#256). Writes through
 * `useTradingMode().setMode` via the parent hook.
 */
