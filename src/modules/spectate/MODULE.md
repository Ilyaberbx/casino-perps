...
- `SpectateLauncher` — **deleted in the casino cut (2026-07-11)**: the casino shell has no header entry point for spectating (sessions still start via the `?spectate=` URL param), and the launcher carried the retired ghost-sprite mark.
