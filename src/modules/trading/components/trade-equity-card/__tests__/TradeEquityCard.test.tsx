...
describe('TradeEquityCard', () => {
  ...
  // Pro mode is gone (PRD-0008 D7): the card always renders its condensed form.
  it('keeps headline + Spot/Perps/uPNL and a single Manage Funds button', () => {
    render(<TradeEquityCard />, { wrapper: wrapEquityCard(buildEquityCardVenue(true)) })
